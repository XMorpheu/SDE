...
namespace SDE
{
    public partial class FiltroRelatoriosCliente : Form
    {
        ...
        public FiltroRelatoriosCliente()
        {
            InitializeComponent();
        ...
        {
             stringSql="SELECT nome,cnpj,cep,bairro FROM tbCliente";
        ...
        private void FiltroRelatoriosCliente_Load(object sender, EventArgs e)
        {
        ...
        private void btnPornomeCli_Click(object sender, EventArgs e)
        {
            ...
            stringSql = "SELECT nome,cep,cnpj,bairro FROM tbCliente  WHERE nome like '" + nome + "%' ";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            stringSql = "SELECT nome,cep,Cnpj,Bairro FROM tbCliente";
        ...
        private void grupNome_Enter(object sender, EventArgs e)
        {
