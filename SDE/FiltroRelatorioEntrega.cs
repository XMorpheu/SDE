...
namespace SDE
{
    public partial class FiltroRelatorioEntrega : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Lista de Entregas", FonteSubtitulo, Brushes.Black, e.MarginBounds.Left + 250, 150, new StringFormat());
            ...
            e.Graphics.DrawString("Numero", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 50, 171, new StringFormat());
            e.Graphics.DrawString("Descrição", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 200, 171, new StringFormat());
            e.Graphics.DrawString("Valor", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 350, 171, new StringFormat());
            e.Graphics.DrawString("Status", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 500, 171, new StringFormat());
            ...
            while ((LinhaAtual < linhasPorPagina && Leitor.Read()))
            {
                ...
                int nome = Leitor.GetInt32(0);
                String rg = Leitor.GetString(1);
                Decimal cpf = Leitor.GetDecimal(2);
        ...
        {
            stringSql = "select numeroEntrega,descricao,valor,statusEntrega FROM tbEntrega";
            ...
            try
            {
...

                {
                    ...
                    objPrintPreview.Text = "Relatorio de Entregas";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            stringSql = " SELECT e.numeroEntrega,e.descricao,valor,e.statusEntrega, c.nome  FROM tbEntrega e inner join tbCliente c on c.codCliente=e.codCliente  WHERE nome like '" + nome + "%'";
        ...
        private void btnPornomeCli_Click(object sender, EventArgs e)
        {
            ...
            stringSql = " SELECT e.numeroEntrega,e.descricao,valor,e.statusEntrega, f.nome  FROM tbEntrega e inner join tbFuncionario f on f.codFuncionario=e.codFuncionario  WHERE nome like '" + nome + "%'";
        ...
        private void btnPordataCli_Click(object sender, EventArgs e)
        {
            ...
            stringSql =" SELECT numeroEntrega,descricao,valor,statusEntrega ,dataEntrega FROM tbEntrega where dataEntrega = '"+data+"'";
        ...
        {
            if (cbmPesquisa.Text == "Nome Motorista")
            {

                grupNome.Visible = true;
                grupData.Visible = false;
                grupGeral.Visible = false;
                groupBox1.Visible = false;

            }
            if (cbmPesquisa.Text == "Data")
            {
                grupNome.Visible = false;
                grupData.Visible = true;
                grupGeral.Visible = false;
                groupBox1.Visible = false;

            }

            if (cbmPesquisa.Text == "Geral")
            {
                grupNome.Visible = false;
                grupData.Visible = false;
                grupGeral.Visible = true;
                groupBox1.Visible = false;

            }

            if (cbmPesquisa.Text == "Nome Cliente")
            {
                grupNome.Visible = false;
                grupData.Visible = false;
                grupGeral.Visible = false;
