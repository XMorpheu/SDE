...
namespace SDE
{
    public partial class FiltroRelatoriosFuncionarios : Form
    {
        ...
        public FiltroRelatoriosFuncionarios()
        {
            InitializeComponent();
        }
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Lista de Funcionários", FonteSubtitulo, Brushes.Black, e.MarginBounds.Left + 250, 150, new StringFormat());
            ...
            e.Graphics.DrawString("CEP", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 200, 171, new StringFormat());
            e.Graphics.DrawString("CPF", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 350, 171, new StringFormat());
            e.Graphics.DrawString("CNH", FonteNegrito, Brushes.Black, e.MarginBounds.Left + 500, 171, new StringFormat());
        ...
        private void btnPornomeCli_Click(object sender, EventArgs e)
        {
            ...
            stringSql = "SELECT nome,cep,cpf,cnh FROM tbFuncionario  WHERE nome like '" + nome + "%' ";
        ...
        {
            stringSql = "SELECT nome,cep,cpf,cnh FROM tbFuncionario";
            ...
            try
            {
...

                {
                    ...
                    objPrintPreview.WindowState = FormWindowState.Maximized;
                    objPrintPreview.PrintPreviewControl.Zoom = 1;
                    objPrintPreview.Text = "Relatorio de Funcionário";
                    objPrintPreview.ShowDialog();
        ...
        private void btnPordataCli_Click(object sender, EventArgs e)
        {
            ...
            stringSql = " select nome,cep,cpf,cnh FROM tbfuncionario where dtNasc = '" + data + "'";
             //define os objetos printdocument e os Eventos Associados
        ...
        private void FiltroRelatoriosFuncionarios_Load(object sender, EventArgs e)
        {
